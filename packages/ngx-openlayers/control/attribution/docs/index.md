...
When the map gets too small because of a resize, the attribution will be collapsed. This is because the `wolCollapsible` property is set to true if the width of the map gets smaller than 600 pixels.
