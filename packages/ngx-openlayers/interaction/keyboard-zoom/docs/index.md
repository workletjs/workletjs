...
also [KeyboardPan](components/interactions/keyboard-pan) component.
...
This example shows how to use the `+` and `-` keys can be used to zoom in and out the map with the
`KeyboardZoom` interaction component.
