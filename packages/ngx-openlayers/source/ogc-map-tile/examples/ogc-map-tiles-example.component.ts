...
@Component({
  selector: 'wol-ogc-map-tiles-example',
    ...
    <wol-map class="h-96">
      ...
      <wol-tile-layer>
        <wol-ogc-map-tile-source
          wolUrl="https://maps.gnosis.earth/ogcapi/collections/blueMarble/map/tiles/WebMercatorQuad"
        />
      </wol-tile-layer>
    </wol-map>
  `,
})
export class WolOGCMapTilesExampleComponent {}
