...
This example uses a [static image](https://xkcd.com/256/) as a layer source. The map view is
configured with a custom projection that translates image coordinates directly into map coordinates.
