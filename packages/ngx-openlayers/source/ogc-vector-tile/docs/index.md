...
Vector tile sets may come in a variety of formats (e.g. GeoJSON, MVT). The `wolFormat` property is used to determine which of the advertised media types is used. If you need to force the use of a particular media type, you can provide the `wolMediaType` property.

## Examples

### OGC Vector Tiles

The [OGC API – Tiles](https://ogcapi.ogc.org/tiles/) specification describes how a service can provide vector tiles.
