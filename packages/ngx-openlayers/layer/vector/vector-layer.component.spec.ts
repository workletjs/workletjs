...
describe('WolVectorLayerComponent', () => {
  let fixture: ComponentFixture<TestVectorLayerComponent>;
  let testComponent: TestVectorLayerComponent;
  let mapInstance: Map;
  let layerComponent: WolVectorLayerComponent;
  let layer: VectorLayer;

  beforeEach(async () => {
    fixture = TestBed.createComponent(TestVectorLayerComponent);
    ...
    layer = layerComponent.getInstance() as VectorLayer;
  });
  ...
  it('should initialize wolStyle on OL instance', () => {
    expect(layer.getStyle()).toBe(testComponent.style());
  });
...
@Component({
  selector: 'wol-test-vector-layer',
  imports: [WolMapComponent, WolViewComponent, WolVectorLayerComponent],
  template: `
    <wol-map>
...
class TestVectorLayerComponent {
