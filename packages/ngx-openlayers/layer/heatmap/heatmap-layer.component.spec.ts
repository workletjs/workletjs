...
describe('WolHeatmapLayerComponent', () => {
  ...
  it('should update wolGradient model and host signal when OL fires change:gradient', () => {
  ...
  it('should update wolRadius model and host signal when OL fires change:radius', () => {
  ...
  it('should update wolBlur model and host signal when OL fires change:blur', () => {
