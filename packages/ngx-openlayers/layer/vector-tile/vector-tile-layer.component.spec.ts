...
const makeSource = () => new VectorTileSource({ tileUrlFunction: () => undefined });

describe('WolVectorTileLayerComponent', () => {
  let fixture: ComponentFixture<TestVectorTileLayerComponent>;
  let testComponent: TestVectorTileLayerComponent;
  let mapInstance: Map;
  let layerComponent: WolVectorTileLayerComponent;
  let layer: VectorTileLayer;

  beforeEach(async () => {
    fixture = TestBed.createComponent(TestVectorTileLayerComponent);
    ...
    layer = layerComponent.getInstance() as VectorTileLayer;
  });
...
@Component({
  selector: 'wol-test-vector-tile-layer',
  imports: [WolMapComponent, WolViewComponent, WolVectorTileLayerComponent],
  template: `
    <wol-map>
...
class TestVectorTileLayerComponent {
  ...
  readonly source = signal<VectorTileSource | undefined>(makeSource());
